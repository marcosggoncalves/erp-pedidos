object Tfrm_usuario: TTfrm_usuario
  ...
  object abas_usuarios: TPageControl
    ...
    object aba_usuario_cadastro: TTabSheet
      ...
      object label_usuario_id: TLabel
        Left = 200
        Top = 30
        Width = 16
        Height = 13
      ...
      object label_usuario_nome: TLabel
        Left = 416
        Top = 30
        Width = 46
        Height = 13
      ...
      object label_cadastro_cpf: TLabel
        Left = 201
        Top = 76
        Width = 23
        Height = 13
      ...
      object label_cadastro_senha: TLabel
        Left = 416
        Top = 76
        Width = 38
        Height = 13
      ...
      object panel_btns_usuarios: TPanel
        ...
        object btn_limpar: TBitBtn
          ...
          TabOrder = 1
          OnClick = btn_limpar_cadastro_click
        end
      ...
      object edit_usuario_nome: TEdit
        Left = 416
        Top = 49
        Width = 261
        Height = 21
        ...
        TabOrder = 2
        TextHint = 'Digite um nome de usu'#225'rio'
      end
      object edit_usuario_senha: TEdit
        Left = 416
        Top = 95
        Width = 261
        Height = 21
        PasswordChar = '*'
        TabOrder = 3
        TextHint = 'Informe uma senha para acesso'
      end
      object edit_usuario_cpf: TEdit
        Left = 200
        Top = 95
        Width = 202
        Height = 21
        TabOrder = 4
        TextHint = 'Informe o CPF do usu'#225'rio'
        OnChange = edit_usuario_cpf_mascara
      end
    end
    object aba_usuario_pesquisa: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object selecionar_filtro_usuario: TComboBox
          Left = 11
          Top = 30
          Width = 161
          Height = 21
